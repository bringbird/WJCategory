...
#define WJAssertNil(condition, description, ...) NSAssert(!(condition), (description), ##__VA_ARGS__)
#define WJCAssertNil(condition, description, ...) NSCAssert(!(condition), (description), ##__VA_ARGS__)

#define WJAssertNotNil(condition, description, ...) NSAssert((condition), (description), ##__VA_ARGS__)
#define WJCAssertNotNil(condition, description, ...) NSCAssert((condition), (description), ##__VA_ARGS__)

#define WJAssertMainThread() NSAssert([NSThread isMainThread], @"This method must be called on the main thread")
#define WJCAssertMainThread() NSCAssert([NSThread isMainThread], @"This method must be called on the main thread")
 ...
 *******************************************************************************
 Example:
 WJSYNTH_DUMMY_CLASS(NSString_WJ)
 */
 ...
 *******************************************************************************
 ...
 #import <objc/runtime.h>
 @implementation NSObject (MyAdd)
 WJSYNTH_DYNAMIC_PROPERTY_CTYPE(myPoint, setMyPoint, CGPoint)
 @end
 */
 ...
 */
static inline NSRange WJNSRangeFromCFRange(CFRange range) {
 ...
 */
static inline CFRange WJCFRangeFromNSRange(NSRange range) {
 ...
 */
static inline CFTypeRef WJCFAutorelease(CFTypeRef CF_RELEASES_ARGUMENT arg) {
...
static inline NSDate *_WJCompileTime(const char *data, const char *time) {
